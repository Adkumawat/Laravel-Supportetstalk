                        ...
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <p> You have total <?php echo @$user_call_count; ?> <span>Listeners</span></p>
                                </div>
                                    ...
                                    <div class="nk-tb-list nk-tb-ulist">
                                        <div class="nk-tb-item nk-tb-head">                                          
                                         ...
                                         use App\Models\Registration;
                                          $i=1;
                                         foreach($user_call_data as $datas){ 
                                         $listners=Registration::where('id',$datas->to_id)->first();
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col">                                               
                                                <div class="user-card">                                                       
                                                    <div class="user-info">
                                                        <span class="tb-lead"><?php echo $datas->username; ?></span>
                                                        <span><?php echo $datas->mobile_number; ?></span>
                                                    </div>
                                                </div>                                               
                                            </div>
                                            <div class="nk-tb-col">
                                                <span class="tb-lead"><?php echo $listners->name; ?></span>
                                                 <span><?php echo $listners->mobile_no; ?></span>
                                            ...
                                            <div class="nk-tb-col tb-col-md">
                                                <?php if(!empty($datas->recorded_url)) { ?>
