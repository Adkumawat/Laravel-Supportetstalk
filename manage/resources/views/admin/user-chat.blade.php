                                ...
                                <div class="card-inner ">
                                    <div class="nk-tb-list nk-tb-ulist">
                                        <div class="nk-tb-item nk-tb-head">                                          
                                            ...
                                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">Chat With Listener</span></div>
                                       ...
                                       // $registrations=Registration::where('id',$data['fields']['listener']['stringValue'])->get();
                                      //  foreach($registrations as $listeners){
                                        ...
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col">                                               
                                                <div class="user-card">                                                       
                                                    <div class="user-info">
                                                        <span class="tb-lead"> <?php echo $data->listner_name?></span>
                                                        <span><?php echo $data->mobile_number ;?></span>
                                                    </div>
                                                </div>                                               
                                            </div>
                                            <div class="nk-tb-col">
