                                ...
                                <div class="card-inner ">
                                    <div class="nk-tb-list nk-tb-ulist">
                                        <div class="nk-tb-item nk-tb-head">                                          
                                            ...
                                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">channel_name</span></div>
                                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">user_id</span></div>
                                           <div class="nk-tb-col tb-col-md"><span class="sub-text">call_start_url</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">call_start_request</span></div>  
                                             <div class="nk-tb-col tb-col-mb"><span class="sub-text">call_stop_url</span></div>
                                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">call_stop_request</span></div>
                                           <div class="nk-tb-col tb-col-md"><span class="sub-text">call_stop_response</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">recorded_url</span></div>    

                                        </div><!-- .nk-tb-item -->
                                        <?php
                                     //dd($documents);
                                        
                                        $i=1; foreach($user_call_data as $data){ 
                                        $registrations=Registration::where('id',$data->to_id)->first();
                                       // dd($registrations);
