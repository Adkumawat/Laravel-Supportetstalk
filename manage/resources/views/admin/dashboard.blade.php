                                                ...
                                                <div class="card-inner-group">
                                                    ...
                                                    <div class="card-innner">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                @foreach($missed_chat_list as $data)
                                                                    <tr>
                                                                        <td>{{ $data->to_id }}</td>
                                                ...
                                                <div class="card-inner-group">
                                                    ...
                                                    <div class="card-innner">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                @foreach($missed_call_list as $data)
                                                                    <tr>
                                                                        <td>{{ $data->listner_id }}</td>
                                                                        <td>{{ $data->created_at->format('Y-m-d') }}</td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                            ...
                                            <div class="card-inner-group">
                                                ...
                                                <div class="card-innner">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            @foreach($recharge_today_list as $data)
                                                                <tr>
